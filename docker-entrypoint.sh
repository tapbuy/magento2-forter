#!/usr/bin/env bash
# Runs inside the tapbuy-ci-php83 container for the forter module.
# Expects volumes:
#   /module                      — forter source (read-only)
...
cp -rT /module /magento/vendor/tapbuy/forter
...
exec php vendor/bin/phpunit \
    ...
    vendor/tapbuy/forter/Test/Unit/
